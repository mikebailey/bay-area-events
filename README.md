...
(`personal/bay-area-events`); the GitHub repo stays flat (`bay-area-events`).

- **Local:** `~/Projects/personal/bay-area-events/`
- **GitHub:** `github.com/mikebailey/bay-area-events`
- **Mirror:** Google Drive (personal) — see below
...
Large data files are **not stored in git**. They live on Google Drive (personal):
...
```bash
python ~/Projects/sync-mirror.py personal/bay-area-events          # audit, changes nothing
python ~/Projects/sync-mirror.py personal/bay-area-events --pull   # mirror -> local
python ~/Projects/sync-mirror.py personal/bay-area-events --push   # local -> mirror
```
...
git clone https://github.com/mikebailey/bay-area-events.git ~/Projects/personal/bay-area-events
cd ~/Projects/personal/bay-area-events
